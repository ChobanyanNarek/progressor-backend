...
export default tseslint.config(
  {
    ignores: [
      ...
      // Generated copy of the web app's sync core (ADR-0019): styled and checked there.
      'src/modules/pm-tracker/sync-core/**',
      // Generated by `pnpm migration:generate` — never hand-styled (ADR-0001).
      // Style rules (line length, formatting) must not touch generated SQL.
      // They are still type-checked (`pnpm typecheck`) and run via ts-node.
